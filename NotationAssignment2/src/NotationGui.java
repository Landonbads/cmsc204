	...
	private class ButtonEventHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			if (e.getSource() == conversionBtn) {
				...
				/*
				 * 
				 * Added last 3 exceptions, remove later
				 */
				catch (InvalidNotationFormatException | StackOverflowException | QueueOverflowException | StackUnderflowException exception)
				{
