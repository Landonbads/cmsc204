...
public class MyQueueTest {
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(v4));
	...
	public void testToStringStudent() throws QueueOverflowException {
		assertEquals("0.10.20.3", doubleQ.toString());
		doubleQ.enqueue(v4);
		assertEquals("0.10.20.30.4", doubleQ.toString());
		doubleQ.enqueue(v5);
		assertEquals("0.10.20.30.40.5", doubleQ.toString());
	}
