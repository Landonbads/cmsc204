...
public class MyStackTest {
	...
	public void testPopStudent() {
		try {
			assertEquals(v3, doubleS.pop());
			assertEquals(v2, doubleS.pop());
			assertEquals(v1, doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(v4));
	...
	public void testToStringStudent() throws StackOverflowException {
		assertEquals("0.10.20.3", doubleS.toString());
		doubleS.push(v4);
		assertEquals("0.10.20.30.4", doubleS.toString());
		doubleS.push(v5);
		assertEquals("0.10.20.30.40.5", doubleS.toString());
	}
